...
def call(String build_number, String artifactory_ip) {
        sh 'curl -L -u "${ARTIFACTORY_CREDENTIALS_USR}:${ARTIFACTORY_CREDENTIALS_PSW}" -O "http://${artifactory_ip}/artifactory/helloworldwar-cicd-libs-release/com/efsavage/hello-world-war/${build_number}/hello-world-war-${build_number}.war"'
        sh 'ls'
